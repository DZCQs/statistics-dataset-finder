...
const DISCOVERY_QUERIES = [
  ...
  "high-dimensional statistics dataset repository",
  "sparse regression dataset statistics",
  "lasso variable selection dataset statistics",
  "regularized regression benchmark dataset statistics",
  "genomics high-dimensional statistics dataset",
  "UCI repository high-dimensional statistics paper",
  "CRAN package data high-dimensional statistics paper",
